...
public class AZWaveSideBarView extends View {
    ...
    private int mSelectBarColor;
    private int mSelectBarSize;
    ...
    private void initAttribute(AttributeSet attrs, int defStyleAttr) {
        ...
        mSelectBarColor = typeArray.getColor(R.styleable.AZWaveSideBarView_selectBarBg, Color.parseColor("#cc00cc"));
        mSelectBarSize = typeArray.getDimensionPixelOffset(R.styleable.AZWaveSideBarView_selectBarSize,
        ...
        mContentPadding = typeArray.getDimensionPixelOffset(R.styleable.AZWaveSideBarView_contentPadding,
                (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 2,
                        getResources().getDisplayMetrics()));
        mBarRightPadding = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 6,
                getResources().getDisplayMetrics());
    ...
    private void initData() {
        ...
        mCirclePaint.setColor(mSelectBarColor);
...
//        drawSelect(canvas);
    ...
    private void drawLetters(Canvas canvas) {
        ...
        for (int index = 0; index < mLetters.size(); index++) {
            float pointY = mSlideBarRect.top + mContentPadding + itemHeight * index + itemHeight / 2;
            float baseLine = TextDrawUtils.getTextBaseLineByCenter(pointY, mTextPaint, mTextSize);
            ...
            if (index == mSelect) {
                ...
                canvas.drawCircle(pointX, pointY, mSelectBarSize, mCirclePaint);
            }
